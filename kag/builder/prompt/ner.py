...
TEMPLATE = """
{
    "instruction": "Bạn là chuyên gia trích xuất thực thể từ văn bản pháp luật Việt Nam về an ninh mạng, bảo vệ dữ liệu cá nhân, báo chí và truyền thông. Đọc đoạn văn trong trường input và liệt kê mọi thực thể quan trọng. Mỗi thực thể trả về 4 trường: name là tên gọi giữ nguyên chữ của văn bản, type là loại chi tiết dạng tự do ví dụ Nghị định hoặc Điều luật hoặc Phạt tiền, category BẮT BUỘC chọn đúng một tên có trong danh sách schema bên dưới và không được bịa tên mới, description là mô tả ngắn gọn dựa trên chính đoạn văn. Quy tắc riêng cho văn bản luật: (1) Mỗi hành vi bị cấm hoặc bị xử phạt là một thực thể riêng với category ProhibitedAct, đặt name là cụm động từ mô tả hành vi, tuyệt đối không đặt name là 'điểm c' hay 'khoản 2'. (2) Mỗi mức phạt tiền, hình thức xử phạt bổ sung, biện pháp khắc phục hậu quả là một thực thể category Sanction, giữ nguyên con số và đơn vị. (3) Nghĩa vụ, trách nhiệm phải làm dùng category Obligation. (4) Tên văn bản như Luật, Nghị định, Thông tư dùng category LegalDocument và name phải kèm số hiệu nếu đoạn văn có nêu. (5) Điều luật dùng category Article, name theo dạng 'Điều 34'. (6) Cơ quan nhà nước, lực lượng có thẩm quyền dùng category Authority. (7) Tổ chức, cá nhân, doanh nghiệp bị điều chỉnh dùng category RegulatedEntity. (8) Thuật ngữ được luật định nghĩa dùng category LegalTerm. (9) Mỗi giá trị định lượng mang tính quy phạm là một thực thể riêng và name PHẢI giữ nguyên con số cùng đơn vị đúng như văn bản, kể cả khi đơn vị không phải tiền: tỉ lệ phần trăm, thời hạn, số lượng, mức hưởng, ngưỡng tối thiểu hoặc tối đa; giữ cả phần chỉ bậc nếu văn bản có nêu, ví dụ 'Mức 1, tối đa bằng 100% mức lương theo hệ số lương hiện hưởng'. Điều kiện định lượng để được cấp, được hưởng, được công nhận và mức định lượng theo bậc đều phải trích, không được bỏ qua chỉ vì chúng không phải hành vi bị cấm hay mức phạt. Với riêng nhóm này TUYỆT ĐỐI không dùng Others, phải chọn một trong các category sau: điều kiện định lượng phải đạt hoặc phải thực hiện dùng Obligation, mức hưởng hoặc mức hỗ trợ định lượng mà nhà nước phải chi trả dùng Obligation, mức phạt tiền theo tỉ lệ dùng Sanction, cơ quan có thẩm quyền dùng Authority, thuật ngữ được định nghĩa kèm ngưỡng dùng LegalTerm, đối tượng bị điều chỉnh dùng RegulatedEntity, hành vi bị cấm dùng ProhibitedAct. (10) Chỉ khi không xếp được vào nhóm nào mới dùng Others. Nếu đoạn văn không có thực thể nào thì trả về danh sách rỗng. Chỉ trả về một chuỗi JSON, không giải thích thêm.",
    "schema": $schema,
    "example": [
        {
